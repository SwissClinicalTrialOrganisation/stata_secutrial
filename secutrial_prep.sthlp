...
{phang}{cmd: .secutrial_prep, zip(path_to_project/original_data/p_export_CSV-xls_PXXXX_YYYYMMDD-hhmmss) path("path_to_project\prepared_data") addid addcentre removesys} {p_end}
