...
The main function is called `secutrial_prep'. It handles, variable label, value labels, dates and datetimes.

An example export options file is included as ExportOptions.html.
The important thing for the program to work is that the metadata options 
